...
let tools = readFileSync(base + "/src/registry/tools.ts", "utf8");
const toolsInsert = `
...
writeFileSync(base + "/src/registry/tools.ts", tools, "utf8");

let perm = readFileSync(base + "/src/registry/permissions.ts", "utf8");
const permInsert = `
...
writeFileSync(base + "/src/registry/permissions.ts", perm, "utf8");
